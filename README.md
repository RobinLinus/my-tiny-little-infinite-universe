...
You might say our universe is boring, still it is infinite. Lots of stuff can happen in an infinite universe. It is so huge, a single particle might occur at a random position. Shot. Its position is almost infinitely large. We can not represent that on my laptop. 
